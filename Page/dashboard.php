            ...
            <div class="box box-default">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <ul class="chart-legend clearfix">
                                ...
                                <li>
                                    <i class="fa fa-circle-o text-yellow"></i> FireFox
                                </li>
                                <li><i class="fa fa-circle-o text-aqua"></i> Safari</li>
                                <li>
                                    <i class="fa fa-circle-o text-light-blue"></i> Opera
                                </li>
                                <li>
                                    <i class="fa fa-circle-o text-gray"></i> Navigator
                                </li>
                            </ul>
                        </div>
                        <!-- /.col -->
                ...
                <div class="box-footer no-padding">
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li>
                            <a href="#">India
                                <span class="pull-right text-green"><i class="fa fa-angle-up"></i> 4%</span></a>
                        </li>
                        <li>
                            <a href="#">China
